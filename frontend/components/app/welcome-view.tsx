...
// === MOTION PROPS FOR THE LARGE TITLE ===
const MotionTitle = motion.create('h1');
const TITLE_MOTION_PROPS = {
...
// === Helper Components (Retained for structure) ===
...
// Assume RetroTvIcon and other icons are defined elsewhere or correctly imported
...
export const WelcomeView = React.forwardRef<HTMLDivElement, any>(
    ({ startButtonText, onStartCall }, ref) => {
        ...
        return (
            <div
                ref={ref}
                // --- FIX 1: Apply Dark Theatrical Background ---
            ...
            >
                ...
                {/* --- LARGE BACKGROUND TITLE (FIXED TO LEFT SIDE, REDUCED SIZE) --- */}
                <MotionTitle
                    {...TITLE_MOTION_PROPS}
                    className="absolute top-1/2 left-0 -translate-y-1/2 
                               /* REDUCED SIZE: Changed from 9xl/8xl range */
                               text-4xl sm:text-5xl md:text-6xl lg:text-7xl 
                               font-black uppercase tracking-widest 
                               opacity-90 pointer-events-none 
                               /* POSITIONING: Anchor left, limit width to half the screen */
                               md:w-1/2 md:text-left md:pl-16 z-0
                               /* Styling: Neon gradient text and heavy glow */
                ...
                {/* --- CONNECTION CARD (FIXED TO RIGHT SIDE, Z-10) --- */}
                {!started && (
                    <section className="relative flex flex-col items-center text-center p-8 
                    /* THEME CHANGE: Dark, Readable Card (Original Aesthetic Retained) */
                    ...
                    w-full max-w-sm mx-4 md:mx-0 z-10 
                    /* POSITIONING: Anchor right in desktop view */
                    md:absolute md:right-16"
                    >
                        
                        {/* The component that caused the error is placed here */}
                        <WelcomeImage /> 
                ...
                {started && (
                    <div className="text-center text-white text-2xl font-bold animate-pulse md:pr-12 drop-shadow-lg z-10">
