...
print("\n" + "🎯" * 50)
print("🚀 DÉJÀ VU CAFE AGENT - DEVELOPED BY KANCHAN SONAWANE")
...
async def complete_order(ctx: RunContext[Userdata]) -> str:
    ...
    try:
        ...
        # --- MODIFICATION: Console confirmation message ---
        print("\n" + "⭐" * 60)
        print("🎉 ORDER COMPLETED SUCCESSFULLY!")
        print(f"👤 Customer: {order.name}")
        print(f"☕ Order: {order.size} {order.drinkType} with {order.milk} milk{extras_text}")
        print("👩‍💻 Developed by Kanchan Sonawane")
        print("⭐" * 60 + "\n")
        
        # --- MODIFICATION: Agent's verbal confirmation message ---
...
👩‍💻 This AI Barista was developed by Kanchan Sonawane."""
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "**Déjà Vu Cafe**".
...
if __name__ == "__main__":
    print("\n" + "⚡" * 25)
    print("🎬 STARTING DÉJÀ VU CAFE AGENT...")
    print("👩‍💻 Developed by Kanchan Sonawane")
    print("⚡" * 25 + "\n")
